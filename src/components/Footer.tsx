          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <Link href="mailto:hello@filmproductionbahrain.com" className="text-film-light/60 hover:text-film-gold transition-colors break-all">
                  hello@filmproductionbahrain.com
                </Link>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-film-gold mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
