...
const faqs = [
  ...
  { question: 'Do you provide color grading services?', answer: 'Yes! We offer professional color grading with Hollywood-grade tools. Our colorists use DaVinci Resolve to create cinematic looks that elevate your footage to broadcast and cinema quality.' },
